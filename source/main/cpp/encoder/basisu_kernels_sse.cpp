...
#    include "ctff/private/encoder/cppspmd_sse.h"
#    include "ctff/private/encoder/cppspmd_type_aliases.h"

using namespace basisu;

#    include "ctff/private/encoder/basisu_kernels_declares.h"
#    include "ctff/private/encoder/basisu_kernels_imp.h"
...
namespace basisu
{
    ...
    static void extract_x86_extended_flags(cpu_info& info, uint32_t ebx) { info.m_has_avx2 = (ebx & (1 << 5)) != 0; }
